<template>
  ...
  <v-container>
    ...
    <v-row>
      ...
      <v-col>
        {{ displayModel.craftingTime }}
      </v-col>
    </v-row>
    <v-row>
      <v-col> Crafting Cost: </v-col>
      <v-col>
        {{ displayModel.crafterCost }}
      </v-col>
    </v-row>
    <v-row>
      <v-col> Material Cost: </v-col>
      <v-col>
        {{ displayModel.materialCost }}
      </v-col>
    </v-row>
  </v-container>
</template>
...
import { getCraftingOfferForDisplay } from "@/Calculators/CalculatorOfCrafteringOffer";
import {
  crafterRankEnum,
...
const displayModel = computed((_) =>
  getCraftingOfferForDisplay(
    props.chosenCrafter as crafterRankEnum,
